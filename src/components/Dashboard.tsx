...
export function Dashboard({
  ...
  return <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <MetricCard title="Cloned Sites" value="27" icon={<GlobeIcon size={20} />} change="12% since yesterday" changeType="negative" />
        <MetricCard title="Recovered Traffic" value="$5,842" icon={<DollarSignIcon size={20} />} change="8% this week" changeType="positive" />
        <MetricCard title="Redirects" value="1,254" icon={<ExternalLinkIcon size={20} />} change="23% this month" changeType="positive" />
        <MetricCard title="Real-time Cloning" value="3 active" icon={<AlertTriangleIcon size={20} />} isActive={true} />
      </div>
      <DashboardCharts />
      <div className="mt-6">
